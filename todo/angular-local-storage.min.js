            ...
            var u = function (a) {
              ...
              x = function () {
                try {
                  ...
                  return (
                    c && ((o = b[t]), o.setItem(d, ""), o.removeItem(d)), c
                  );
                } catch (b) {
                  return (
                  ...
                  try {
                    o && o.setItem(u(b), c),
                      s.setItem &&
                        a.$broadcast(
                          "LocalStorageModule.notification.setitem",
                          { key: b, newvalue: c, storageType: p.storageType }
                        );
                  } catch (d) {
                    return (
                      a.$broadcast(
                      ...
                      try {
                        o.removeItem(u(e)),
                          s.removeItem &&
                            a.$broadcast(
                              "LocalStorageModule.notification.removeitem",
                              { key: e, storageType: p.storageType }
                            );
                      } catch (b) {
                        a.$broadcast(
                          "LocalStorageModule.notification.error",
              ...
              E = (function () {
                try {
                  return (
                    ...
                    ("cookie" in k &&
                      (k.cookie.length > 0 ||
                        (k.cookie = "test").indexOf.call(k.cookie, "test") >
                          -1))
                  );
                } catch (b) {
                  return (
                  ...
                  if (
                    (null === c
                      ...
                      ? (m.setTime(m.getTime() + 24 * h * 60 * 60 * 1e3),
                        (l = "; expires=" + m.toGMTString()))
                      : 0 !== r.expiry &&
                        (m.setTime(m.getTime() + 24 * r.expiry * 60 * 60 * 1e3),
                        (l = "; expires=" + m.toGMTString())),
                    b)
                  ) {
                    var o = "; path=" + r.path;
                    r.domain && (n = "; domain=" + r.domain),
                      "boolean" == typeof i
                        ...
                        : r.secure === !0 && (n += "; secure"),
                      (k.cookie =
                        u(b) + "=" + encodeURIComponent(c) + l + o + n);
                  }
                } catch (b) {
                  return (
                    a.$broadcast(
              ...
              G = function (b) {
                ...
                for (
                  var c = (k.cookie && k.cookie.split(";")) || [], d = 0;
                  d < c.length;
                  d++
                ) {
                  ...
                  if (0 === e.indexOf(u(b) + "=")) {
                    var f = decodeURIComponent(
                      e.substring(q.length + b.length + 1, e.length)
                    );
                    try {
                      var g = JSON.parse(f);
              ...
              I = function () {
                for (
                  var a = null, b = q.length, c = k.cookie.split(";"), d = 0;
                  d < c.length;
                  d++
                ) {
